...
"[project]/Desktop/clock in:out/apps/web/src/app/api/admin/notifications/counts/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        // 1. Pending Recaps
        const recapsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].recap.count({
            where: {
                status: "PENDING"
            }
        });
        // 2. Pending Shift Release & Assign Approvals
        const pendingReleasesCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].releaseRequest.count({
            where: {
                status: "PENDING"
            }
        });
        const pendingAssignsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].shiftRequest.count({
            where: {
                status: "PENDING"
            }
        });
        ...
        const releasedShiftsCount = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].job.count({
            where: {
                status: "OPEN",
                sourceReleaseId: {
                    not: null
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52eb3687._.js.map