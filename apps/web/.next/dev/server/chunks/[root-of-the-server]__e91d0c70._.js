...
"[project]/Desktop/clock in:out/apps/web/src/app/api/admin/dashboard-details/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (type === "jobs") {
            ...
            const data = jobs.map((job)=>({
                    ...
                    assignedWorker: [
                        ...new Set(job.assignments.map((a)=>a.worker?.name).filter(Boolean))
                    ].join(", ") || "Unassigned"
                }));
            return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                data
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e91d0c70._.js.map