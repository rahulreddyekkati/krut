...
"[project]/Desktop/clock in:out/apps/web/src/app/api/admin/reports/payroll/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (!startDateStr || !endDateStr) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$apiError$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("Missing date range", 400);
        }
        ...
        const startDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["localTimeToUTC"])(startDateStr, "00:00", tz);
        const endDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$timezone$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["localTimeToUTC"])(endDateStr, "23:59", tz);
        if (endDate <= startDate) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$apiError$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AppError"]("endDate must be after startDate", 400);
        }
        ...
        const payrollData = users.map((user)=>{
            ...
            user.jobs.forEach((assignment)=>{
                ...
                if (typeof assignment.workedHours === 'number') {
                    totalWorkedHours += assignment.workedHours;
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(payrollData);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f0e84daf._.js.map