...
"[project]/Desktop/clock in:out/apps/web/src/app/api/admin/recaps/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const recaps = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].recap.findMany({
            where: {
                ...dateFilter,
                ...statusFilter,
                job: jobWhere
        ...
        const data = recaps.map((r)=>{
            ...
            const assignmentWithTimes = r.job.assignments?.find((a)=>a.clockIn || a.clockOut) || r.job.assignments?.[0];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2117d56._.js.map