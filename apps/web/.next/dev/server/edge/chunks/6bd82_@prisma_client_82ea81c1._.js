(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/6bd82_@prisma_client_82ea81c1._.js",
"[project]/Desktop/clock in:out/node_modules/@prisma/client/runtime/wasm.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var Wo = Object.getPrototypeOf, Ko = Object.prototype.hasOwnProperty;
...
var _e = (e, t)=>()=>(t || e((t = {
    ...
    if (t && typeof t == "object" || typeof t == "function") for (let i of Go(t))!Ko.call(e, i) && i !== r && At(e, i, {
        get: ()=>t[i],
        enumerable: !(n = Jo(t, i)) || n.enumerable
    });
    return e;
};
var tt = (e, t, r)=>(r = e != null ? Qo(Wo(e)) : {}, an(t || !e || !e.__esModule ? At(r, "default", {
        value: e,
        enumerable: !0
    }) : r, e)), Ho = (e)=>an(At({}, "__esModule", {
        value: !0
    }), e);
function hr(e, t) {
...
function zo(e) {
    let r = Object.getOwnPropertyNames(DataView.prototype).filter((a)=>a.startsWith("get") || a.startsWith("set")), n = r.map((a)=>a.replace("get", "read").replace("set", "write")), i = (a, f)=>function(y = 0) {
            return B(y, "offset"), z(y, "offset"), $(y, "offset", this.length - 1), new DataView(this.buffer)[r[a]](y, f);
        }, o = (a, f)=>function(y, T = 0) {
            let C = r[a].match(/set(\w+\d+)/)[1].toLowerCase(), O = Xo[C];
            return B(T, "offset"), z(T, "offset"), $(T, "offset", this.length - 1), Yo(y, "value", O[0], O[1]), new DataView(this.buffer)[r[a]](T, y, f), T + parseInt(r[a].match(/\d+/)[0]) / 8;
        }, s = (a)=>{
        a.forEach((f)=>{
...
var h, Xo, Zo, es, ts, rs, b, yr, u = le(()=>{
    "use strict";
    h = class e extends Uint8Array {
        ...
        writeUIntBE(r, n, i) {
            B(n, "offset"), z(n, "offset"), $(n, "offset", this.length - 1), B(i, "byteLength"), z(i, "byteLength");
        ...
        compare(r, n = 0, i = r.length, o = 0, s = this.length) {
            return Ot(r, "target"), B(n, "targetStart"), B(i, "targetEnd"), B(o, "sourceStart"), B(s, "sourceEnd"), $(n, "targetStart"), $(i, "targetEnd", r.length), $(o, "sourceStart"), $(s, "sourceEnd", this.length), e.compare(this.slice(o, s), r.slice(n, i));
        }
        equals(r) {
            return Ot(r, "otherBuffer"), this.length === r.length && this.every((n, i)=>n === r[i]);
        }
        copy(r, n = 0, i = 0, o = this.length) {
            $(n, "targetStart"), $(i, "sourceStart", this.length), $(o, "sourceEnd"), n >>>= 0, i >>>= 0, o >>>= 0;
            let s = 0;
        ...
        write(r, n, i, o = "utf8") {
            ...
            return o = typeof n == "string" ? n : typeof i == "string" ? i : o, B(s, "offset"), B(a, "length"), $(s, "offset", this.length), $(a, "length", this.length), (o === "ucs2" || o === "ucs-2" || o === "utf16le" || o === "utf-16le") && (a = a - a % 2), hr(r, o).copy(this, s, 0, a);
        }
        fill(r = 0, n = 0, i = this.length, o = "utf-8") {
            let s = typeof n == "string" ? 0 : n, a = typeof i == "string" ? this.length : i;
            if (o = typeof n == "string" ? n : typeof i == "string" ? i : o, r = e.from(typeof r == "number" ? [
                r
            ] : r ?? [], o), ln(o, "encoding"), $(s, "offset", this.length), $(a, "end", this.length), r.length !== 0) for(let f = s; f < a; f += r.length)super.set(r.slice(0, r.length + f >= this.length ? this.length - f : r.length), f);
            return this;
        }
        ...
        indexOf(r, n = null, i = "utf-8", o = !1) {
            ...
            let a = e.from(typeof r == "number" ? [
                r
            ] : r, i), f = typeof n == "string" ? 0 : n;
            return f = typeof n == "number" ? f : null, f = Number.isNaN(f) ? null : f, f ??= o ? this.length : 0, f = f < 0 ? this.length + f : f, a.length === 0 && o === !1 ? f >= this.length ? this.length : f : a.length === 0 && o === !0 ? (f >= this.length ? this.length : f) || this.length : s((y, T)=>(o ? T <= f : T >= f) && this[T] === a[0] && a.every((O, A)=>this[T + A] === O));
        }
        toString(r = "utf8", n = 0, i = this.length) {
            ...
            if (r === "binary" || r === "ascii" || r === "latin1" || r === "latin-1") return this.slice(n, i).reduce((o, s)=>o + yr(s & (r === "ascii" ? 127 : 255)), "");
            if (r === "ucs2" || r === "ucs-2" || r === "utf16le" || r === "utf-16le") {
                let o = new DataView(this.buffer.slice(n, i));
                return Array.from({
                    length: o.byteLength / 2
                }, (s, a)=>a * 2 + 1 < o.byteLength ? yr(o.getUint16(a * 2, !0)) : "").join("");
            }
    ...
    }, Zo = new TextEncoder, es = new TextDecoder, ts = [
        "utf8",
        "utf-8",
        "hex",
        "base64",
...
function dn(e, t) {
    var r, n, i, o, s, a, f, y, T = e.constructor, C = T.precision;
    if (!e.s || !t.s) return t.s || (t = new T(e)), U ? D(t, C) : t;
    if (f = e.d, y = t.d, s = e.e, i = t.e, f = f.slice(), o = s - i, o) {
        for(o < 0 ? (n = f, o = -o, a = y.length) : (n = y, i = s, a = f.length), s = Math.ceil(C / N), a = s > a ? s + 1 : a + 1, o > a && (o = a, n.length = 1), n.reverse(); o--;)n.push(0);
        n.reverse();
    }
    for(a = f.length, o = y.length, a - o < 0 && (o = a, n = y, y = f, f = n), r = 0; o;)r = (f[--o] = f[o] + y[o] + r) / Q | 0, f[o] %= Q;
...
function fn(e, t) {
    var r, n, i, o, s, a, f = 0, y = 0, T = e.constructor, C = T.precision;
    if (V(e) > 16) throw Error(wr + V(e));
    if (!e.s) return new T(Z);
    for(t == null ? (U = !1, a = C) : a = t, s = new T(.03125); e.abs().gte(.1);)e = e.times(s), y += 5;
    for(n = Math.log(Ae(2, y)) / Math.LN10 * 2 + 5 | 0, a += n, r = i = o = new T(Z), T.precision = a;;){
        if (i = D(i.times(e), a), r = r.times(++f), s = o.plus(be(i, r, a)), ue(s.d).slice(0, a) === ue(o.d).slice(0, a)) {
...
function br(e, t, r) {
    if (t > e.LN10.sd()) throw U = !0, r && (e.precision = r), Error(ne + "LN10 precision limit exceeded");
...
function rt(e, t) {
    var r, n, i, o, s, a, f, y, T, C = 1, O = 10, A = e, k = A.d, S = A.constructor, I = S.precision;
    if (A.s < 1) throw Error(ne + (A.s ? "NaN" : "-Infinity"));
    if (A.eq(Z)) return new S(0);
    if (t == null ? (U = !1, y = I) : y = t, A.eq(10)) return t == null && (U = !0), br(S, y);
    if (y += O, S.precision = y, r = ue(k), n = r.charAt(0), o = V(A), Math.abs(o) < 15e14) {
        for(; n < 7 && n != 1 || n == 1 && r.charAt(1) > 3;)A = A.times(e), r = ue(A.d), n = r.charAt(0), C++;
        o = V(A), n > 1 ? (A = new S("0." + r), o++) : A = new S(n + "." + r.slice(1));
    } else return f = br(S, y + 2, I).times(o + ""), A = rt(new S(n + "." + r.slice(1)), y - O).plus(f), S.precision = I, t == null ? (U = !0, D(A, I)) : A;
    for(a = s = A = be(A.minus(Z), A.plus(Z), y), T = D(A.times(A), y), i = 3;;){
        if (s = D(s.times(T), y), f = a.plus(be(s, new S(i), y)), ue(f.d).slice(0, y) === ue(a.d).slice(0, y)) return a = a.times(2), o !== 0 && (a = a.plus(br(S, y + 2, I).times(o + ""))), a = be(a, new S(C), y), S.precision = I, t == null ? (U = !0, D(a, I)) : a;
        a = f, i += 2;
    }
}
function cn(e, t) {
    ...
    if (t = t.slice(n, i), t) {
        if (i -= n, r = r - n - 1, e.e = De(r / N), e.d = [], n = (r + 1) % N, r < 0 && (n += N), n < i) {
...
function D(e, t, r) {
    ...
    if (r !== void 0 && (o = Ae(10, s - i - 1), a = y / o % 10 | 0, f = t < 0 || C[T + 1] !== void 0 || y % o, f = r < 4 ? (a || f) && (r == 0 || r == (e.s < 0 ? 3 : 2)) : a > 5 || a == 5 && (r == 4 || f || r == 6 && (n > 0 ? i > 0 ? y / Ae(10, s - i) : 0 : C[T - 1]) % 10 & 1 || r == (e.s < 0 ? 8 : 7))), t < 1 || !C[0]) return f ? (o = V(e), C.length = 1, t = t - o - 1, C[0] = Ae(10, (N - t % N) % N), e.e = De(-t / N) || 0) : (C.length = 1, C[0] = e.e = e.s = 0), e;
    if (n == 0 ? (C.length = T, o = 1, T--) : (C.length = T + 1, o = Ae(10, N - n), C[T] = i > 0 ? (y / Ae(10, s - i) % Ae(10, i) | 0) * o : 0), f) for(;;)if (T == 0) {
        (C[0] += o) == Q && (C[0] = 1, ++e.e);
        break;
    } else {
...
function gn(e, t) {
    var r, n, i, o, s, a, f, y, T, C, O = e.constructor, A = O.precision;
    if (!e.s || !t.s) return t.s ? t.s = -t.s : t = new O(e), U ? D(t, A) : t;
    if (f = e.d, C = t.d, n = t.e, y = e.e, f = f.slice(), s = y - n, s) {
        for(T = s < 0, T ? (r = f, s = -s, a = C.length) : (r = C, n = y, a = f.length), i = Math.max(Math.ceil(A / N), a) + 2, s > i && (s = i, r.length = 1), r.reverse(), i = s; i--;)r.push(0);
        r.reverse();
    } else {
    ...
    for(T && (r = f, f = C, C = r, t.s = -t.s), a = f.length, i = C.length - a; i > 0; --i)f[a++] = 0;
    for(i = C.length; i > s;){
        if (f[--i] < C[i]) {
...
function Oe(e, t, r) {
    var n, i = V(e), o = ue(e.d), s = o.length;
...
function hn(e) {
    ...
    if (i.prototype = R, i.ROUND_UP = 0, i.ROUND_DOWN = 1, i.ROUND_CEIL = 2, i.ROUND_FLOOR = 3, i.ROUND_HALF_UP = 4, i.ROUND_HALF_DOWN = 5, i.ROUND_HALF_EVEN = 6, i.ROUND_HALF_CEIL = 7, i.ROUND_HALF_FLOOR = 8, i.clone = hn, i.config = i.set = ss, e === void 0 && (e = {}), e) for(n = [
        "precision",
        "rounding",
        "toExpNeg",
        "toExpPos",
...
function ss(e) {
    ...
    for(t = 0; t < i.length; t += 3)if ((n = e[r = i[t]]) !== void 0) if (De(n) === n && n >= i[t + 1] && n <= i[t + 2]) this[r] = n;
    else throw Error(Se + r + ": " + n);
    if ((n = e[r = "LN10"]) !== void 0) if (n == Math.LN10) this[r] = new this(n);
    else throw Error(Se + r + ": " + n);
    return this;
}
var Le, is, Er, U, ne, Se, wr, De, Ae, os, Z, Q, N, pn, kt, R, be, Er, It, yn = le(()=>{
    "use strict";
    u();
    c();
    m();
    ...
    }, U = !0, ne = "[DecimalError] ", Se = ne + "Invalid argument: ", wr = ne + "Exponent out of range: ", De = Math.floor, Ae = Math.pow, os = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Q = 1e7, N = 7, pn = 9007199254740991, kt = De(pn / N), R = {};
    ...
    R.squareRoot = R.sqrt = function() {
        ...
        for(e = V(a), U = !1, i = Math.sqrt(+a), i == 0 || i == 1 / 0 ? (t = ue(a.d), (t.length + e) % 2 == 0 && (t += "0"), i = Math.sqrt(t), e = De((e + 1) / 2) - (e < 0 || e % 2), i == 1 / 0 ? t = "5e" + e : (t = i.toExponential(), t = t.slice(0, t.indexOf("e") + 1) + e), n = new f(t)) : n = new f(i.toString()), r = f.precision, i = s = r + 3;;)if (o = n, n = o.plus(be(a, o, s + 2)).times(.5), ue(o.d).slice(0, s) === (t = ue(n.d)).slice(0, s)) {
    ...
    R.times = R.mul = function(e) {
        var t, r, n, i, o, s, a, f, y, T = this, C = T.constructor, O = T.d, A = (e = new C(e)).d;
        if (!T.s || !e.s) return new C(0);
        for(e.s *= T.s, r = T.e + e.e, f = O.length, y = A.length, f < y && (o = O, O = A, A = o, s = f, f = y, y = s), o = [], s = f + y, n = s; n--;)o.push(0);
        for(n = y; --n >= 0;){
            for(t = 0, i = f + n; i > n;)a = o[i] + A[n] * O[i - n - 1] + t, o[i--] = a % Q | 0, t = a / Q | 0;
            o[i] = (o[i] + t) % Q | 0;
        }
        for(; !o[--s];)o.pop();
    ...
    R.toDecimalPlaces = R.todp = function(e, t) {
        ...
        return r = new n(r), e === void 0 ? r : (ce(e, 0, Le), t === void 0 ? t = n.rounding : ce(t, 0, 8), D(r, e + V(r) + 1, t));
    };
    R.toExponential = function(e, t) {
        var r, n = this, i = n.constructor;
        return e === void 0 ? r = Oe(n, !0) : (ce(e, 0, Le), t === void 0 ? t = i.rounding : ce(t, 0, 8), n = D(new i(n), e + 1, t), r = Oe(n, !0, e + 1)), r;
    };
    R.toFixed = function(e, t) {
        var r, n, i = this, o = i.constructor;
        return e === void 0 ? Oe(i) : (ce(e, 0, Le), t === void 0 ? t = o.rounding : ce(t, 0, 8), n = D(new o(i), e + V(i) + 1, t), r = Oe(n.abs(), !1, e + V(n) + 1), i.isneg() && !i.isZero() ? "-" + r : r);
    };
    ...
    R.toPower = R.pow = function(e) {
        var t, r, n, i, o, s, a = this, f = a.constructor, y = 12, T = +(e = new f(e));
        ...
        if (t = e.e, r = e.d.length - 1, s = t >= r, o = a.s, s) {
            if ((r = T < 0 ? -T : T) <= pn) {
                for(i = new f(Z), t = Math.ceil(n / N + 4), U = !1; r % 2 && (i = i.times(a), mn(i.d, t)), r = De(r / 2), r !== 0;)a = a.times(a), mn(a.d, t);
                return U = !0, e.s < 0 ? new f(Z).div(i) : D(i, n);
            }
        } else if (o < 0) throw Error(ne + "NaN");
        return o = o < 0 && e.d[Math.max(t, r)] & 1 ? -1 : 1, a.s = 1, U = !1, i = e.times(rt(a, n + y)), U = !0, i = fn(i), i.s = o, i;
    };
    R.toPrecision = function(e, t) {
        var r, n, i = this, o = i.constructor;
        return e === void 0 ? (r = V(i), n = Oe(i, r <= o.toExpNeg || r >= o.toExpPos)) : (ce(e, 1, Le), t === void 0 ? t = o.rounding : ce(t, 0, 8), i = D(new o(i), e, t), r = V(i), n = Oe(i, e <= r || r <= o.toExpNeg, e)), n;
    };
    R.toSignificantDigits = R.tosd = function(e, t) {
        var r = this, n = r.constructor;
        return e === void 0 ? (e = n.precision, t = n.rounding) : (ce(e, 1, Le), t === void 0 ? t = n.rounding : ce(t, 0, 8)), D(new n(r), e, t);
    };
    ...
    be = function() {
        ...
        return function(n, i, o, s) {
            var a, f, y, T, C, O, A, k, S, I, ie, K, Me, H, L, gr, oe, Ct, Rt = n.constructor, jo = n.s == i.s ? 1 : -1, ae = n.d, q = i.d;
            if (!n.s) return new Rt(n);
            if (!i.s) throw Error(ne + "Division by zero");
            for(f = n.e - i.e, oe = q.length, L = ae.length, A = new Rt(jo), k = A.d = [], y = 0; q[y] == (ae[y] || 0);)++y;
            if (q[y] > (ae[y] || 0) && --f, o == null ? K = o = Rt.precision : s ? K = o + (V(n) - V(i)) + 1 : K = o, K < 0) return new Rt(0);
            if (K = K / N + 2 | 0, y = 0, oe == 1) for(T = 0, q = q[0], K++; (y < L || T) && K--; y++)Me = T * Q + (ae[y] || 0), k[y] = Me / q | 0, T = Me % q | 0;
            else {
                for(T = Q / (q[0] + 1) | 0, T > 1 && (q = e(q, T), ae = e(ae, T), oe = q.length, L = ae.length), H = oe, S = ae.slice(0, oe), I = S.length; I < oe;)S[I++] = 0;
                Ct = q.slice(), Ct.unshift(0), gr = q[0], q[1] >= Q / 2 && ++gr;
                do T = 0, a = t(q, S, oe, I), a < 0 ? (ie = S[0], oe != I && (ie = ie * Q + (S[1] || 0)), T = ie / gr | 0, T > 1 ? (T >= Q && (T = Q - 1), C = e(q, T), O = C.length, I = S.length, a = t(C, S, O, I), a == 1 && (T--, r(C, oe < O ? Ct : q, O))) : (T == 0 && (a = T = 1), C = q.slice()), O = C.length, O < I && C.unshift(0), r(S, C, I), a == -1 && (I = S.length, a = t(q, S, oe, I), a < 1 && (T++, r(S, oe < I ? Ct : q, I))), I = S.length) : a === 0 && (T++, S = [
                    0
                ]), k[y++] = T, a && S[0] ? S[I++] = ae[H] || 0 : (S = [
                    ae[H]
                ], I = 1);
...
var Dr = _e((xg, Xn)=>{
    ...
    Xn.exports = function() {
        ...
        return function(t, r) {
            ...
            var a = 0, f, y, T, C, O, A, k, S, I, ie, K, Me, H = [];
            for(f = 0; f < i; f++)H.push(f + 1), H.push(t.charCodeAt(s + f));
            for(var L = H.length - 1; a < o - 3;)for(I = r.charCodeAt(s + (y = a)), ie = r.charCodeAt(s + (T = a + 1)), K = r.charCodeAt(s + (C = a + 2)), Me = r.charCodeAt(s + (O = a + 3)), A = a += 4, f = 0; f < L; f += 2)k = H[f], S = H[f + 1], y = e(k, y, T, I, S), T = e(y, T, C, ie, S), C = e(T, C, O, K, S), A = e(C, O, A, Me, S), H[f] = A, O = C, C = T, T = y, y = k;
            for(; a < o;)for(I = r.charCodeAt(s + (y = a)), A = ++a, f = 0; f < L; f += 2)k = H[f], H[f] = A = e(k, y, A, I, H[f + 1]), y = k;
            return A;
        };
    }();
});
...
var vr = class {
    ...
    let t = new vr, r = pe(t, e.transactionContext.bind(e)), n = {
...
d();
l();
var Cr, xn, Pn, vn, Tn = !0;
typeof g < "u" && ({ FORCE_COLOR: Cr, NODE_DISABLE_COLORS: xn, NO_COLOR: Pn, TERM: vn } = g.env || {}, Tn = g.stdout && g.stdout.isTTY);
var cs = {
    enabled: !xn && Pn == null && vn !== "dumb" && (Cr != null && Cr !== "0" || Tn)
};
function F(e, t) {
...
var Du = F(0, 0), Mt = F(1, 22), _t = F(2, 22), Fu = F(3, 23), Cn = F(4, 24), Nu = F(7, 27), Uu = F(8, 28), qu = F(9, 29), Bu = F(30, 39), Fe = F(31, 39), Rn = F(32, 39), An = F(33, 39), Sn = F(34, 39), Vu = F(35, 39), On = F(36, 39), $u = F(37, 39), kn = F(90, 39), ju = F(90, 39), Qu = F(40, 49), Ju = F(41, 49), Gu = F(42, 49), Wu = F(43, 49), Ku = F(44, 49), Hu = F(45, 49), zu = F(46, 49), Yu = F(47, 49);
var ms = 100, In = [
    "green",
    "yellow",
    "blue",
    ...
    "cyan",
    "red"
], Lt = [], Mn = Date.now(), ps = 0, Rr = typeof g < "u" ? g.env : {};
...
function ds(e) {
    let t = {
        ...
        if (n.length !== 0 && Lt.push([
            o,
            ...n
        ]), Lt.length > ms && Lt.shift(), it.enabled(o) || i) {
            let f = n.map((T)=>typeof T == "string" ? T : fs(T)), y = `+${Date.now() - Mn}ms`;
            Mn = Date.now(), a(o, ...f, y);
        }
    };
    return new Proxy(r, {
...
function Ne(e) {
    let t = Ts();
    return t || (e?.config.engineType === "library" ? "library" : e?.config.engineType === "binary" ? "binary" : e?.config.engineType === "client" ? "client" : qn);
}
function Ts() {
...
l();
function qe(e) {
    return e === null ? e : Array.isArray(e) ? e.map(qe) : typeof e == "object" ? ks(e) ? Is(e) : Ue(e, qe) : e;
}
function ks(e) {
...
function Fs({ functionName: e, location: t, message: r, isPanic: n, contextLines: i, callArguments: o }, s) {
    let a = [
        ""
    ], f = t ? " in" : ":";
    if (n ? (a.push(s.red(`Oops, an unknown error occurred! This is ${s.bold("on us")}, you did nothing wrong.`)), a.push(s.red(`It occurred in the ${s.bold(`\`${e}\``)} invocation${f}`))) : a.push(s.red(`Invalid ${s.bold(`\`${e}\``)} invocation${f}`)), t && a.push(s.underline(Ns(t))), i) {
        a.push("");
        let y = [
            i.toString()
        ];
...
function qt(e) {
    let t = e.showColors ? _s : Ls, r;
    return typeof $getTemplateParameters < "u" ? r = $getTemplateParameters(e, t) : r = Ds(e), Fs(r, t);
}
u();
c();
m();
...
l();
function ti(e, t, r) {
    let n = ri(e), i = Us(n), o = Bs(i);
    o ? Bt(o, t, r) : t.addErrorMessage(()=>"Unknown error");
}
function ri(e) {
    return e.errors.flatMap((t)=>t.kind === "Union" ? ri(t) : [
            t
        ]);
}
function Us(e) {
...
var Je = class extends ve {
    ...
    writeWithItems(r) {
        ...
        r.writeLine("[").withIndent(()=>r.writeJoined(Qe, this.items).newLine()).write("]"), this.hasError && r.afterNextNewline(()=>{
...
var Ge = class e extends ve {
    ...
    getDeepField(r) {
        ...
        for (let a of i){
            let f;
            if (s.value instanceof e ? f = s.value.getField(a) : s.value instanceof Je && (f = s.value.getField(Number(a))), !f) return;
            s = f;
        }
        return s;
    }
...
function Gs(e, t) {
    ...
    n && (n.removeAllFields(), ai(n, r)), t.addErrorMessage((o)=>i ? `The ${o.red("`select`")} statement for type ${o.bold(r.name)} must not be empty. ${mt(o)}` : `The ${o.red("`select`")} statement for type ${o.bold(r.name)} needs ${o.bold("at least one truthy value")}.`);
}
function Ws(e, t) {
    let r = new ut;
...
function zs(e, t) {
    ...
    n && (n.getField(r)?.markAsError(), sa(n, e.arguments)), t.addErrorMessage((i)=>oi(i, r, e.arguments.map((o)=>o.name)));
}
function Ys(e, t) {
    ...
    t.addErrorMessage((o)=>oi(o, n, e.inputType.fields.map((s)=>s.name)));
}
function oi(e, t, r) {
    let n = [
...
function Xs(e, t) {
    let r;
    t.addErrorMessage((f)=>r?.value instanceof J && r.value.text === "null" ? `Argument \`${f.green(o)}\` must not be ${f.red("null")}.` : `Argument \`${f.green(o)}\` is missing.`);
    let n = t.arguments.getDeepSubSelectionValue(e.selectionPath)?.asObject();
    if (!n) return;
...
function Zs(e, t) {
    ...
    n && n.getDeepFieldValue(e.argumentPath)?.markAsError(), t.addErrorMessage((i)=>{
        let o = Qt("or", e.argument.typeNames.map((s)=>i.green(s)));
...
function ea(e, t) {
    ...
    n && n.getDeepFieldValue(e.argumentPath)?.markAsError(), t.addErrorMessage((i)=>{
        ...
        if (e.underlyingError && o.push(`: ${e.underlyingError}`), o.push("."), e.argument.typeNames.length > 0) {
            let s = Qt("or", e.argument.typeNames.map((a)=>i.green(a)));
            o.push(` Expected ${s}.`);
        }
        return o.join("");
    });
...
function ra(e, t) {
    ...
    t.addErrorMessage((i)=>{
        ...
        return e.constraints.minFieldCount === 1 ? e.constraints.requiredFields ? o.push(`${i.green("at least one of")} ${Qt("or", e.constraints.requiredFields.map((s)=>`\`${i.bold(s)}\``))} arguments.`) : o.push(`${i.green("at least one")} argument.`) : o.push(`${i.green(`at least ${e.constraints.minFieldCount}`)} arguments.`), o.push(mt(i)), o.join(" ");
    });
}
function na(e, t) {
...
function ia(e, t) {
    for (let r of t.fields)r.isRelation && !e.hasField(r.name) && e.addSuggestion(new re(r.name, "true"));
}
function oa(e, t) {
    for (let r of t.fields)!e.hasField(r.name) && !r.isRelation && e.addSuggestion(new re(r.name, "true"));
}
function sa(e, t) {
...
d();
l();
var Jt = Symbol(), Fr = new WeakMap, xe = class {
    constructor(t){
        t === Jt ? Fr.set(this, `Prisma.${this._getName()}`) : Fr.set(this, `new Prisma.${this._getNamespace()}.${this._getName()}()`);
    }
    _getName() {
...
var mi = ": ", Wt = class {
    ...
    write(t) {
        ...
        this.hasError && r.underline().setColor(t.context.colors.red), t.write(r).write(mi).write(this.value);
    }
};
var Ur = class {
    constructor(t){
...
function di(e) {
    ...
    if (e instanceof Uint8Array) return b.isBuffer(e) ? new J(`Buffer.alloc(${e.byteLength})`) : new J(`new Uint8Array(${e.byteLength})`);
    if (e instanceof Date) {
        let t = Ut(e) ? e.toISOString() : "Invalid Date";
        return new J(`new Date("${t}")`);
    }
    return e instanceof xe ? new J(`Prisma.${e._getName()}`) : We(e) ? new J(`prisma.${ci(e.modelName)}.$fields.${e.name}`) : Array.isArray(e) ? ua(e) : typeof e == "object" ? pi(e) : new J(Object.prototype.toString.call(e));
}
function ua(e) {
    let t = new Je;
...
function Kt(e, t) {
    let r = t === "pretty" ? ni : jt, n = e.renderAllMessages(r), i = new je(0, {
        colors: r
    }).write(e).toString();
    return {
        message: n,
...
function Ht({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
    let a = Ke(e);
    for (let C of t)Bt(C, a, s);
    let { message: f, args: y } = Kt(a, r), T = qt({
        message: f,
        callsite: n,
        originalMethod: i,
        showColors: r === "pretty",
...
function gi(e, t, r) {
    let n = ge(r);
    return !t.result || !(t.result.$allModels || t.result[n]) ? e : ca({
        ...e,
...
function fi(e, t, r) {
    return r ? Ue(r, ({ needs: n, compute: i }, o)=>({
            name: o,
...
var zt = class {
    constructor(t, r){
        ...
        this.clientExtensions = yt(()=>this.extension.client ? {
    ...
    getAllComputedFields(t) {
        return this.computedFieldsCache.getOrCreate(t, ()=>gi(this.previous?.getAllComputedFields(t), this.extension, t));
    }
...
function Zt({ modelName: e, action: t, args: r, runtimeDataModel: n, extensions: i = He.empty(), callsite: o, clientMethod: s, errorFormat: a, clientVersion: f, previewFeatures: y, globalOmit: T }) {
    let C = new qr({
        runtimeDataModel: n,
        modelName: e,
        action: t,
...
function fa(e, t, r) {
    let n = {};
    return e.modelOrType && !e.isRawAction() && (n.$composites = !0, n.$scalars = !0), t && ga(n, t, e), ha(n, r, e), n;
}
function ga(e, t, r) {
...
function ya(e, t) {
    let r = {}, n = t.getComputedFields(), i = hi(e, n);
...
function vi(e, t) {
    ...
    for(let n in e){
        ...
        he(i) || (i !== void 0 ? r[n] = Pi(i, o) : t.isPreviewFeatureOn("strictUndefinedChecks") && t.throwValidationError({
            kind: "InvalidArgumentValue",
...
var qr = class e {
    ...
    getGlobalOmit() {
        return this.params.modelName && this.shouldApplyGlobalOmit() ? this.params.globalOmit?.[Be(this.params.modelName)] ?? {} : {};
    }
...
l();
function Ti(e) {
    if (!e._hasPreviewFlag("metrics")) throw new G("`metrics` preview feature must be enabled in order to access metrics API", {
...
var ze = class {
    ...
    prometheus(t) {
        return Ti(this._client), this._client._engine.metrics({
            format: "prometheus",
            ...t
        });
    }
...
d();
l();
var jr = new WeakMap, er = "$$PrismaTypedSql", Qr = class {
    constructor(t, r){
        jr.set(this, {
            sql: t,
            values: r
...
function se(e, t) {
    let r = va(t), n = new Set, i = new Proxy(e, {
        get (o, s) {
        ...
        ownKeys (o) {
            let s = _i(Reflect.ownKeys(o), r), a = _i(Array.from(r.keys()), r);
            return [
                ...new Set([
                    ...s,
                    ...a,
...
function ir({ error: e, user_facing_error: t }, r, n) {
    return t.error_code ? new Y(Ca(t, n), {
        code: t.error_code,
        clientVersion: r,
        meta: t.meta,
...
function Ca(e, t) {
    let r = e.message;
    return (t === "postgresql" || t === "postgres" || t === "mysql") && e.error_code === Ta && (r += `
...
function Te(e) {
    return typeof $EnabledCallSite == "function" && e !== "minimal" ? new $EnabledCallSite : new Wr;
}
u();
c();
m();
...
function Xe(e = {}) {
    let t = Aa(e);
    return Object.entries(t).reduce((n, [i, o])=>(Di[i] !== void 0 ? n.select[i] = {
            select: o
        } : n[i] = o, n), {
        select: {}
    });
...
l();
function Bi(e, t) {
    let r = t.fields.filter((i)=>!i.relationName), n = _r(r, (i)=>i.name);
    return new Proxy({}, {
        get (i, o) {
...
d();
l();
var Vi = (e)=>Array.isArray(e) ? e : e.split("."), Kr = (e, t)=>Vi(t).reduce((r, n)=>r && r[n], e), $i = (e, t, r)=>Vi(t).reduceRight((n, i, o, s)=>Object.assign({}, Kr(e, s.slice(0, o)), {
            [i]: n
        }), r);
function Ma(e, t) {
...
function Hr(e, t, r, n, i, o) {
    let a = e._runtimeDataModel.models[t].fields.reduce((f, y)=>({
            ...f,
            [y.name]: y
        }), {});
    return (f)=>{
        let y = Te(e._errorFormat), T = Ma(n, i), C = _a(f, o, T), O = r({
            dataPath: T,
            callsite: y
        })(C), A = La(e, t);
        return new Proxy(O, {
...
function Na(e, t) {
    let r = ge(t), n = Object.keys(Dt.ModelAction).concat("count");
    return {
        getKeys () {
            return n;
        },
...
function Va(e) {
    let t = Object.keys(e._runtimeDataModel.models), r = t.map(ge), n = [
        ...new Set(t.concat(r))
    ];
    return ke({
        getKeys () {
...
function sr({ visitor: e, result: t, args: r, runtimeDataModel: n, modelName: i }) {
    if (Array.isArray(t)) {
        for(let s = 0; s < t.length; s++)t[s] = sr({
            result: t[s],
            args: r,
            modelName: i,
            runtimeDataModel: n,
...
function Wi({ includeOrSelect: e, result: t, parentModelName: r, runtimeDataModel: n, visitor: i }) {
...
function Ki({ result: e, modelName: t, args: r, extensions: n, runtimeDataModel: i, globalOmit: o }) {
    return n.isEmpty() || e == null || typeof e != "object" || !i.models[t] ? e : sr({
        result: e,
        args: r ?? {},
        modelName: t,
        runtimeDataModel: i,
...
d();
l();
var ro = ee("prisma:client"), no = {
    Vercel: "vercel",
    "Netlify CI": "netlify"
};
function io({ postinstall: e, ciName: t, clientVersion: r }) {
    if (ro("checkPlatformCaching:postinstall", e), ro("checkPlatformCaching:ciName", t), e === !0 && t && t in no) {
...
d();
l();
var Ja = "Cloudflare-Workers", Ga = "node";
function so() {
    return typeof Netlify == "object" ? "netlify" : typeof ("TURBOPACK compile-time value", "edge-runtime") == "string" ? "edge-light" : globalThis.navigator?.userAgent === Ja ? "workerd" : globalThis.Deno ? "deno" : globalThis.__lagon__ ? "lagon" : globalThis.process?.release?.name === Ga ? "node" : globalThis.Bun ? "bun" : globalThis.fastly ? "fastly" : "unknown";
}
var Wa = {
    node: "Node.js",
...
function ar({ inlineDatasources: e, overrideDatasources: t, env: r, clientVersion: n }) {
    ...
    if (o === void 0 ? i = void 0 : a ? i = a : s?.value ? i = s.value : s?.fromEnvVar && (i = r[s.fromEnvVar]), s?.fromEnvVar !== void 0 && i === void 0) throw Ce().id === "workerd" ? new M(`error: Environment variable not found: ${s.fromEnvVar}.
...
var Xr, lo = {
    async loadLibrary (e) {
        ...
        if (r === void 0) throw new M(`The \`adapter\` option for \`PrismaClient\` is required in this context (${Ce().prettyName})`, t);
...
var Ka = "P2036", ye = ee("prisma:client:libraryEngine");
function Ha(e) {
...
var vt = class {
    constructor(t, r){
        ...
        this.libraryLoader = r ?? lo, this.config = t, this.libraryStarted = !1, this.logQueries = t.logQueries ?? !1, this.logLevel = t.logLevel ?? "error", this.logEmitter = t.logEmitter, this.datamodel = t.inlineSchema, this.tracingHelper = t.tracingHelper, t.enableDebugLogs && (this.logLevel = "debug");
    ...
    async transaction(t, r, n) {
        ...
        if (Za(s)) {
            ...
            throw a ? a.error : new Y(s.message, {
                code: s.error_code,
                clientVersion: this.config.clientVersion,
                meta: s.meta
            });
        } else if (typeof s.message == "string") throw new j(s.message, {
            clientVersion: this.config.clientVersion
        });
        return s;
    }
    ...
    logger(t) {
        ...
        r && (r.level = r?.level.toLowerCase() ?? "unknown", Ha(r) ? this.logEmitter.emit("query", {
            timestamp: new Date,
            query: r.query,
            params: r.params,
            duration: Number(r.duration_ms),
            target: r.module_path
        }) : (za(r), this.logEmitter.emit(r.level, {
            timestamp: new Date,
            message: r.message,
            target: r.module_path
        })));
    ...
    async stop() {
        if (await this.libraryStartingPromise, await this.executingQueryPromise, this.libraryStoppingPromise) return ye("library is already stopping"), this.libraryStoppingPromise;
        if (!this.libraryStarted) return;
        let t = async ()=>{
            ...
            await this.engine?.disconnect(JSON.stringify(r)), this.libraryStarted = !1, this.libraryStoppingPromise = void 0, ye("library stopped");
        };
...
${a.backtrace}`, {
    ...
    async requestBatch(t, { transaction: r, traceparent: n }) {
        ...
        if (Array.isArray(a)) return a.map((y)=>y.errors && y.errors.length > 0 ? this.loggerRustPanic ?? this.buildQueryError(y.errors[0]) : {
                data: y
            });
...
d();
l();
var Tt = "Accelerate has not been setup correctly. Make sure your client is using `.$extends(withAccelerate())`. See https://pris.ly/d/accelerate-getting-started", lr = class {
    constructor(t){
        this.config = t;
...
function uo({ copyEngine: e = !0 }, t) {
    ...
    let i = Ne(t.generator), o = n || !e, s = !!t.adapter, a = i === "library", f = i === "binary", y = i === "client";
    if (o && s || s && !1) {
        let T;
        throw e ? r?.startsWith("prisma://") ? T = [
...
var rl = /^(\s*alter\s)/i, bo = ee("prisma:client");
function en(e, t, r, n) {
    if (!(e !== "postgresql" && e !== "cockroachdb") && r.length > 0 && rl.exec(t)) throw new Error(`Running ALTER using ${n} is not supported
...
var tn = ({ clientMethod: e, activeProvider: t })=>(r)=>{
        let n = "", i;
        if (Si(r)) n = r.sql, i = {
            values: Ze(r.values),
        ...
        return i?.values ? bo(`prisma.${e}(${n}, ${i.values})`) : bo(`prisma.${e}(${n})`), {
            query: n,
            parameters: i
        };
    }, wo = {
...
var nl = Or.split(".")[0], il = {
    ...
    getGlobalTracingHelper() {
        let t = globalThis[`V${nl}_PRISMA_INSTRUMENTATION`], r = globalThis.PRISMA_INSTRUMENTATION;
...
function Co(e) {
    ...
    let t = [];
    return e.modelName && t.push(e.modelName), e.query.arguments && t.push(on(e.query.arguments)), t.push(on(e.query.selection)), t.join("");
}
function on(e) {
...
var al = ee("prisma:client:request_handler"), fr = class {
    constructor(t, r){
        this.logEmitter = r, this.client = t, this.dataloader = new pr({
            batchLoader: Zi(async ({ requests: n, customDataProxyFetch: i })=>{
                let { transaction: o, otelParentCtx: s } = n[0], a = n.map((C)=>C.protocolQuery), f = this.client._tracingHelper.getTraceParent(s), y = n.some((C)=>sn(C.protocolQuery.action));
            ...
            singleLoader: async (n)=>{
                let i = n.transaction?.kind === "itx" ? Ao(n.transaction) : void 0, o = await this.client._engine.request(n.protocolQuery, {
            ...
            batchBy: (n)=>n.transaction?.id ? `transaction-${n.transaction.id}` : Co(n.protocolQuery),
            batchOrder (n, i) {
    ...
    handleRequestError({ error: t, clientMethod: r, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (f = qt({
            ...
            if (t instanceof j) throw new j(f, {
                clientVersion: this.client._clientVersion,
                batchRequestIdx: t.batchRequestIdx
            });
    ...
    sanitizeMessage(t) {
        return this.client._errorFormat && this.client._errorFormat !== "pretty" ? (0, Ro.default)(t) : t;
    }
    unpack(t, r, n) {
        if (!t || (t.data && (t = t.data), !t)) return t;
        let i = Object.keys(t)[0], o = Object.values(t)[0], s = r.filter((y)=>y !== "select" && y !== "include"), a = Kr(o, s), f = i === "queryRaw" ? dr(a) : qe(a);
        return n ? n(f) : f;
    }
    get [Symbol.toStringTag]() {
...
It should have this form: { url: "CONNECTION_STRING" }`);
    ...
    adapter: (e, t)=>{
        if (!e && Ne(t.generator) === "client") throw new _('Using engine type "client" requires a driver adapter to be provided to PrismaClient constructor.');
        if (e === null) return;
        ...
        if (Ne(t.generator) === "binary") throw new _('Cannot use a driver adapter with the "binary" Query Engine. Please use the "library" Query Engine.');
    },
    datasourceUrl: (e)=>{
...
function No(e) {
    return e.length === 0 ? Promise.resolve([]) : new Promise((t, r)=>{
        ...
        for(let y = 0; y < e.length; y++)e[y].then((T)=>{
            n[y] = T, a();
        }, (T)=>{
            if (!mr(T)) {
                f(T);
...
}, yl = Symbol.for("prisma.client.transaction.id"), bl = {
    id: 0,
    nextId () {
        return ++this.id;
    }
...
function Bo(e) {
    class t {
        constructor(n){
            ...
            this._extensions = He.empty(), this._previewFeatures = ur(e), this._clientVersion = e.clientVersion ?? ko, this._activeProvider = e.activeProvider, this._globalOmit = n?.omit, this._tracingHelper = Po();
            let o = {
                rootEnvPath: e.relativeEnvPaths.rootEnvPath && ot.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath),
                schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && ot.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath)
            }, s;
            if (n?.adapter) {
                s = Tr(n.adapter);
            ...
            try {
                let f = n ?? {}, y = f.__internal ?? {}, T = y.debug === !0;
                T && ee.enable("prisma:client");
                let C = ot.resolve(e.dirname, e.relativePath);
                Ln.existsSync(C) || (C = e.dirname), Re("dirname", e.dirname), Re("relativePath", e.relativePath), Re("cwd", C);
                let O = y.engine || {};
                if (f.errorFormat ? this._errorFormat = f.errorFormat : g.env.NODE_ENV === "production" ? this._errorFormat = "minimal" : g.env.NO_COLOR ? this._errorFormat = "colorless" : this._errorFormat = "colorless", this._runtimeDataModel = e.runtimeDataModel, this._engineConfig = {
                    ...
                    logQueries: f.log && !!(typeof f.log == "string" ? f.log === "query" : f.log.find((A)=>typeof A == "string" ? A === "query" : A.level === "query")),
                    env: a?.parsed ?? {},
                    flags: [],
                ...
                }, Re("clientVersion", e.clientVersion), this._engine = uo(e, this._engineConfig), this._requestHandler = new fr(this, i), f.log) for (let A of f.log){
        ...
        $executeRaw(n, ...i) {
            return this._createPrismaPromise((o)=>{
                if (n.raw !== void 0 || n.sql !== void 0) {
                    let [s, a] = Uo(n, i);
                    return en(this._activeProvider, s.text, s.values, Array.isArray(n) ? "prisma.$executeRaw`<SQL>`" : "prisma.$executeRaw(sql`<SQL>`)"), this.$executeRawInternal(o, "$executeRaw", s, a);
                }
        ...
        $executeRawUnsafe(n, ...i) {
            return this._createPrismaPromise((o)=>(en(this._activeProvider, n, i, "prisma.$executeRawUnsafe(<SQL>, [...values])"), this.$executeRawInternal(o, "$executeRawUnsafe", [
                    n,
                    ...i
                ])));
        }
        $runCommandRaw(n) {
            if (e.activeProvider !== "mongodb") throw new G(`The ${e.activeProvider} provider does not support $runCommandRaw. Use the mongodb provider.`, {
                clientVersion: this._clientVersion
            });
        ...
        $queryRaw(n, ...i) {
            return this._createPrismaPromise((o)=>{
                if (n.raw !== void 0 || n.sql !== void 0) return this.$queryRawInternal(o, "$queryRaw", ...Uo(n, i));
                throw new G("`$queryRaw` is a tag function, please use it like the following:\n```\nconst result = await prisma.$queryRaw`SELECT * FROM User WHERE id = ${1} OR email = ${'user@email.com'};`\n```\n\nOr read our docs at https://www.prisma.io/docs/concepts/components/prisma-client/raw-database-access#queryraw\n", {
                    clientVersion: this._clientVersion
                });
            });
        }
        $queryRawTyped(n) {
            return this._createPrismaPromise((i)=>{
                if (!this._hasPreviewFlag("typedSql")) throw new G("`typedSql` preview feature must be enabled in order to access $queryRawTyped API", {
                    clientVersion: this._clientVersion
                });
        ...
        _transactionWithArray({ promises: n, options: i }) {
            let o = bl.nextId(), s = vo(n.length), a = n.map((f, y)=>{
                ...
                let T = i?.isolationLevel ?? this._engineConfig.transactionOptions.isolationLevel, C = {
                    kind: "batch",
                    id: o,
                    index: y,
                    isolationLevel: T,
        ...
        _request(n) {
            ...
            let i = n.middlewareArgsMapper ?? hl, o = {
                ...
                if (T) return this._tracingHelper.runInChildSpan(s.middleware, (I)=>T(y, (ie)=>(I?.end(), f(ie))));
                let { runInTransaction: C, args: O, ...A } = y, k = {
                    ...n,
                    ...A
                };
                O && (k.args = i.middlewareArgsToRequestArgs(O)), n.transaction !== void 0 && C === !1 && delete k.transaction;
        ...
        async _executeRequest({ args: n, clientMethod: i, dataPath: o, callsite: s, action: a, model: f, argsMapper: y, transaction: T, unpacker: C, otelParentCtx: O, customDataProxyFetch: A }) {
            try {
                n = y ? y(n) : n;
                let k = {
                    name: "serialize"
                }, S = this._tracingHelper.runInChildSpan(k, ()=>Zt({
                        modelName: f,
                        runtimeDataModel: this._runtimeDataModel,
                        action: a,
                        args: n,
                ...
                return ee.enabled("prisma:client") && (Re("Prisma Client call:"), Re(`prisma.${i}(${Li(n)})`), Re("Generated request:"), Re(JSON.stringify(S, null, 2) + `
...
module.exports = {
    ...__turbopack_context__.r("[project]/Desktop/clock in:out/node_modules/.prisma/client/default.js [middleware-edge] (ecmascript)")
};
}),
]);

//# sourceMappingURL=6bd82_%40prisma_client_82ea81c1._.js.map