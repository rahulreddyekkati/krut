...
function ReleasedShiftsPage() {
    _s();
    const [assignments, setAssignments] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [assigning, setAssigning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [selectedWorker, setSelectedWorker] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReleasedShiftsPage.useEffect": ()=>{
            fetch("/api/admin/released-shifts").then({
                "ReleasedShiftsPage.useEffect": (r)=>r.json()
            }["ReleasedShiftsPage.useEffect"]).then({
                "ReleasedShiftsPage.useEffect": (d)=>setAssignments(Array.isArray(d) ? d : [])
            }["ReleasedShiftsPage.useEffect"]).catch({
                "ReleasedShiftsPage.useEffect": ()=>{}
            }["ReleasedShiftsPage.useEffect"]).finally({
                "ReleasedShiftsPage.useEffect": ()=>setLoading(false)
            }["ReleasedShiftsPage.useEffect"]);
            fetch("/api/users/workers").then({
                "ReleasedShiftsPage.useEffect": (r)=>r.json()
            }["ReleasedShiftsPage.useEffect"]).then({
                "ReleasedShiftsPage.useEffect": (d)=>setWorkers(Array.isArray(d) ? d : [])
            }["ReleasedShiftsPage.useEffect"]).catch({
                "ReleasedShiftsPage.useEffect": ()=>{}
            }["ReleasedShiftsPage.useEffect"]);
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            ...
            loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                lineNumber: 69,
                columnNumber: 17
            }, this) : assignments.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                marketWorkers.map((w)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$clock__in$3a$out$2f$apps$2f$web$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: w.id,
                                                        children: w.name
                                                    }, w.id, false, {
                                                        fileName: "[project]/Desktop/clock in:out/apps/web/src/app/admin/released-shifts/page.tsx",
...
_s(ReleasedShiftsPage, "pdw6srQPa0eV6pzW0CsIYVikfx4=");
